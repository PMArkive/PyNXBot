...
def getspecies(species, isgmax=False, formid=0, isShiny=False):
    ...
    if species == 849:
        ...
        t = (
            ...
            + pmtext.species[species]
            + "]]"
            + ("<br />[[File:Dynamax Sprite.png|link=Gigantamax]]" if isgmax else "")
        )
    elif species == 869:
        t = (
            "{{MSP|"
        ...
        t = (
            ...
            + pmtext.species[species]
            + "]]"
            + (f"<br>FormeID:{formid}" if formid > 0 else "")
        )
...
def getform_short(species, isgmax=False, formid=0, isShiny=False):
    ...
    if species in [422, 423, 849, 869, 678, 876] or (
...
if ShortVersion:
    ...
    print(
        "! Pokémon !! Rate !! Games !! Level !! Flawless<br>IVs !! Shield !! Dynamax<br>Level !! Dynamax<br>Boost !! Moves  !! Drop  !! Bonus !! Comment"
    )
    ...
    for ii in range(eventencounter.TablesLength()):
        ...
        print('|- class="bgl-' + ver + '"')
        print(
            "! ★(Rate) !! Pokémon !! Level !! Flawless<br>IVs !! Shield !! Dynamax<br>Level !! Dynamax<br>Boost !! Moves  !! Drop  !! Bonus !! Comment"
        )
    ...
    if ShortVersion:
        ...
        for ii in range(tablelength):
            ...
            if (
                ...
                msg += (
                    f"|yes|yes|Throw Dynamax Crystals|{entry1.Level()}|{{{{tt|one|Redeem serial number}}}}"
                    + "}}}}"
                )
                print(msg)
            else:
                ...
                msg += "|" + gettype_short(entry1.Species(), entry1.AltForm())
                msg += (
                    f"|yes|no|Throw Dynamax Crystals|{entry1.Level()}|{{{{tt|one|Redeem serial number}}}}"
                    + "}}}}"
                )
                print(msg)
                msg = header + getspecies_short(
                ...
                msg += (
                    f"|no|yes|Throw Dynamax Crystals|{entry1.Level()}|{{{{tt|one|Redeem serial number}}}}"
                    + "}}}}"
                )
                print(msg)
    else:
        ...
        print(
            "! Dynamax Crystal !! Pokémon !! ★ !! Games !! Level !! IVs !! Shield !! Dynamax<br>Level !! Dynamax<br>Boost !! Moves  !! Drop  !! Bonus !! Comment"
        )
