...
* [ldn_mitm](https://github.com/spacemeowx2/ldn_mitm) (SwSh only)
* [Luxray](https://github.com/3096/luxray) (only for some bots, SwSh only)
...
## Credits:
* [olliz0r](https://github.com/olliz0r) for the great [sys-botbase](https://github.com/olliz0r/sys-botbase) which allows us open sockets on the Nintendo Switch
* [spacemeowx2](https://github.com/spacemeowx2) for the livesafer sys-module [ldn_mitm](https://github.com/spacemeowx2/ldn_mitm). It avoids Switch to disconnect from wifi once SwSh game is opened
* [3096](https://github.com/3096) for the great days advancer Switch tool [Luxray](https://github.com/3096/ipswitch)
